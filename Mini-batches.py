...
# Definir optimizador (solo uno, ya que el cambio es de batch size)
...
# Tamaños de mini-batch a probar
...
for batch_size in batch_sizes:
    ...
    # Actualizar los DataLoaders con el nuevo batch size
...
# Lista de marcadores
markers = ['o', 's', 'D', '^', 'v', '<', '>', '*', 'p', 'h']  # Puedes añadir más si tienes más batch sizes

# Graficar con líneas y diferentes marcadores
for i, batch_size in enumerate(batch_sizes):
    marker = markers[i % len(markers)]  # Usar marcadores de la lista, reutilizando si hay más batch sizes que marcadores
